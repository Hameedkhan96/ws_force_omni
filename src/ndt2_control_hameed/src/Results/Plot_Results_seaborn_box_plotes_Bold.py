...
# Set global font properties for boldness
rcParams.update({'font.weight': 'bold', 'axes.labelweight': 'bold'})
...
ax1.set_title('Rectangular Trajectory in contact while sliding', fontsize=16, fontweight='bold')

# Set tick labels font properties
font_prop = FontProperties(weight='bold', size=12)
...
# Set tick labels font properties for 2D plot
ax2.tick_params(axis='x', labelsize=12)
ax2.tick_params(axis='y', labelsize=12)

# Set tick labels font properties manually
